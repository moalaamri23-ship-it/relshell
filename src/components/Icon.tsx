export const Icon = ({ name, className = 'w-5 h-5' }: { name: string; className?: string }) => {
  const paths: Record<string, string> = {
    ...
    expand:       'M9 3.75H4.5m0 0v4.5m0-4.5L10 9.5M15 3.75h4.5m0 0v4.5m0-4.5L14 9.5M9 20.25H4.5m0 0v-4.5m0 4.5L10 14.5M15 20.25h4.5m0 0v-4.5m0 4.5L14 14.5',
    compress:     'M10 4.5V9m0 0H5.5M10 9 4.5 3.5M14 4.5V9m0 0h4.5M14 9l5.5-5.5M10 19.5V15m0 0H5.5M10 15l-5.5 5.5M14 19.5V15m0 0h4.5M14 15l5.5 5.5',
  }
